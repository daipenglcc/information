...
!(function () {
    ...
    exports.code128 = function (ctx, text, width, height) {
        ...
        var lineWidth = (width - ctx.measureText(text).width) / 2;
        ctx.fillText(text, lineWidth, 217)
    ...
    Graphics.prototype.fillBgRect = function (x1, y1, width, height) {
        //绘制背景色
        let x = 0,
            y = 0,
            w = width,
